...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/images/videa.png') }}" sizes="32x32"/>
    <link rel="icon" type="image/png" href="{{ asset('assets/images/videa.png') }}" sizes="16x16"/>
    <style>
    html
    {
