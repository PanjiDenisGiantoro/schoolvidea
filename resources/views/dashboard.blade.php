...
@section('content')
    ...
    <div class="row ">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Ringkasan Tagihan</h4>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-6 border-end">
                            <p class="text-muted mb-1 small">Tagihan Masuk</p>
                            <h5 class="fw-bold text-success">Rp {{ number_format($tagihanData['nominal_tagihan'] ?? 0, 0, ',', '.') }}</h5>
                        </div>
                        <div class="col-6">
                            <p class="text-muted mb-1 small">Sudah Dibayar</p>
                            <h5 class="fw-bold text-info">Rp {{ number_format($tagihanData['sudah_dibayar'] ?? 0, 0, ',', '.') }}</h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6 border-end">
                            <p class="text-muted mb-1 small">Belum Dibayar</p>
                            <h5 class="fw-bold text-warning">Rp {{ number_format($tagihanData['belum_dibayar'] ?? 0, 0, ',', '.') }}</h5>
                        </div>
                        <div class="col-6">
                            <p class="text-muted mb-1 small">Total Data</p>
                            <h5 class="fw-bold text-primary">{{ $tagihanData['jumlah_data'] ?? 0 }}</h5>
                        </div>
                    </div>
                    <a href="{{ url('tagihan') }}" class="btn btn-primary btn-sm mt-3 w-100">Kelola Tagihan</a>
                </div>
            </div>
        </div>
