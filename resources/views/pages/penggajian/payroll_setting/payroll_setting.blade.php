        ...
        <div class="card-body">
            <form id="settingPayrollForm"
                ...
                <div id="form-section" style="{{ isset($setting) ? 'display: block;' : 'display: none;' }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <x-input-field type="text" id="position_display" name="position_display" label="Jabatan"
                                readonly :disabled="true" value="" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-2">
                            <x-input-field type="number" name="teaching_hours" label="Jml Jam Ajar (jam)"
                                placeholder="Jumlah" :disabled="$readonly" :readonly="$readonly"
                        ...
                        @foreach ($allowances as $key => $label)
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" name="{{ $key }}_allowance"
                                    id="{{ $key }}_allowance" class="form-control" placeholder="Nonaktif"
                                    inputmode="numeric" disabled style="font-size: 16px; padding: 10px 12px;"
                        ...
                        @if (isset($setting) && $setting->components->count())
                            @foreach ($setting->components as $comp)
                                <div class="row g-3 component-row">
                                    <div class="col-md-4">
                                        <x-input-field type="text" name="position" label="Jabatan" readonly
                                            :disabled="true"
                                            value="{{ $setting->officer?->position?->position_name ?? '' }}" />
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="row g-3 component-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="component_value[]"
                                    ...
                                    oninput="formatCurrencyInput(this)" readonly>
                            </div>
                        </div>
                    </template>
                        ...
                        @if (isset($setting) && $setting->deductions->count())
                            @foreach ($setting->deductions as $ded)
                                <div class="row g-3 deduction-row">
                                    <div class="col-md-4">
                                        <x-input-field type="text" name="type_deduction" label="Tipe Potongan"
                                            readonly :disabled="isset($show)" value="{{ $ded->type }}" />
                                    </div>
                                    <div class="col-md-4">
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                officerSelect.addEventListener('change', async () => {
                    ...
                    try {
                        ...
                        document.getElementById('position_display').value = data.position_name || '-';
