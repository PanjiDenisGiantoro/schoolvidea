                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="debit" id="debit" class="form-select">
                                ...
                                <option value="1" {{ old('debit', $setting->debit ?? '') == 1 ? 'selected' : '' }}>1
                                </option>
                                <option value="0" {{ old('debit', $setting->debit ?? '') === 0 ? 'selected' : '' }}>0
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" id="keterangan" class="form-control p-3" rows="1"  placeholder="Masukkan Keterangan">{{ old('keterangan', $setting->keterangan ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-select">
                                <option value="1"
                                    {{ old('status', $setting->status ?? '') == '1' ? 'selected' : '' }}>Aktif</option>
                                <option value="0"
                                    {{ old('status', $setting->status ?? '') == '0' ? 'selected' : '' }}>Tidak Aktif
                                </option>
                            </select>
                        </div>
                    </div>
