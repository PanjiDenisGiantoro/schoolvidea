                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <x-input-field type="text" name="kode_jurusan" label="Kode Jurusan"
                                       placeholder="Masukkan Kode Jurusan" icon="bx bx-barcode"
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const formElements = document.querySelectorAll('#jurusanForm input, #jurusanForm textarea, #jurusanForm select, #jurusanForm button[type="submit"]');
