                    ...
                    <form method="GET" action="{{ route('lembagaunit.index') }}" class="row g-3">
                        ...
                        <div class="col-md-{{ auth()->user()->unit_id === null ? '7' : '10' }}">
                            <input type="text" name="search" class="form-control p-3"
                                placeholder="Cari lembaga (Nama, Code, Email, Telp, dll...)"
                ...
                <div class="col-lg-12">
                    <div class="pagination-wrapper">
                        <div class="pagination-info">
                            ...
                            Menampilkan {{ $lembagaunit->firstItem() ?? 0 }} sampai {{ $lembagaunit->lastItem() ?? 0 }}
                            dari {{ $lembagaunit->total() }} data
                        </div>
                        <div>
                            {{ $lembagaunit->links('vendor.pagination.custom') }}
                        </div>
                    </div>
                </div>
            </div>
