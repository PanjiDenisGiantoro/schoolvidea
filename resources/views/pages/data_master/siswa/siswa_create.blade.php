                ...
                <div class="row g-3 mt-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="kelas_id" id="kelas_id" class="form-select" @if (isset($show) && $show) disabled @endif>
                ...
                kelasSelect.addEventListener('change', function() {
                    ...
                    fetch(`/siswa/jurusan-by-unit/${unitId}`)
                        ...
                        .then(data => {
                            ...
                            if (data.length === 0) {
                                jurusanSelect.innerHTML = '<option value="">Tidak ada jurusan tersedia</option>';
                                return;
                            }
                        ...
                        .catch(error => {
                            ...
                            jurusanSelect.innerHTML = '<option value="">Gagal memuat data jurusan</option>';
                        });
                });
            }
        });
