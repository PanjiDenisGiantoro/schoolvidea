            ...
            >
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="text-muted">
                            Pilih yayasan yang terkait dengan unit ini
                        </p>
                        <hr />
                        <div class="mb-3">
                            <label for="yayasan_id" class="form-label">
                                Yayasan
                            </label>
                            <select
                                name="yayasan_id"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            >
                                <option
                                    value="1"
                                    {{ old("status", $unit->status ?? "") == "1" ? "selected" : "" }}
                                >
                                    Aktif
                                </option>
                                <option
                    ...
                    <div class="col-md-4">
                        <x-input-field
                            type="text"
                            name="nama_pimpinan_unit"
                            label="Nama Pimpinan"
                            placeholder="Masukkan Nama Pimpinan"
                            icon="bx bx-user"
                            :value="old('nama_pimpinan_unit', $unit->nama_pimpinan_unit ?? '')"
                        />
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            >
{{ old("alamat", $unit->alamat ?? "") }}</textarea
                            >
                        </div>
                        <div class="mb-3">
                ...
                <div class="mt-3 text-end">
                    ...
                    <a href="{{ url("unit/") }}" class="btn btn-secondary">
                        Batal
                    </a>
                </div>
            </form>
