        ...
        <div class="card-body">
            <div class="row g-5">
                ...
                <div class="col-lg-12 mb-3">
                    <form
                        method="GET"
                        action="{{ route("data-rekening.index") }}"
                        class="row g-3"
                    >
                        ...
                        >
                            <input
                                ...
                                placeholder="Cari Rekening (Nama, Kode, Unit...)"
                ...
                <table
                    id="datatable"
                    class="table-bordered table-striped table text-center align-middle text-nowrap"
                >
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-3">
                                        <a
                                            href="{{ url("data-rekening/show", $item->id ?? "") }}"
                                        ...
                                        <a
                                            href="{{ route("data-rekening.edit", $item->id ?? "") }}"
                                        ...
                                        <a
                                            href="{{ route("data-rekening.destroy", $item->id ?? "") }}"
