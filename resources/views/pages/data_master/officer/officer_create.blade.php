        ...
        <div class="card-body">
            <form id="userForm"
                ...
                <div class="row">
                    <!-- Colom - 1 -->
                    <div class="col-md-3">
                        <x-input-field type="text" id="nip" name="nip" label="NIP" class="text-uppercase"
                    ...
                    <div class="col-md-3">
                        <x-input-field type="text" id="nuptk" name="nuptk" label="NUPTK"
                            ...
                            @if (Auth::user()->yayasan_id)
                                <div class="mb-4">
                                    ...
                                    <select name="akses_yayasan" id="akses_yayasan" class="form-select" data-choices
                                        ...
                                        <option value="ya"
                                            {{ old('akses_yayasan', $officer->user->yayasan_id ?? '') ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="tidak"
                                            {{ old('akses_yayasan', $officer->user->yayasan_id ?? '') == '' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                    <small class="text-muted">Jika "Ya", user akan memiliki akses ke semua unit dalam
                                        yayasan</small>
                                </div>
                            @endif
