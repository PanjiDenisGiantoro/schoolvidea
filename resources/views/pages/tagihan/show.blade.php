                    ...
                    <div class="col-md-8 p-4">
                        ...
                        >
                            <li class="mb-2 info-row">
                                ...
                                >
                                    {{ optional($tagihanSiswa->first()->tagihan->unit)->nama_unit ?? "-" }}
                                </span>
                            </li>
                            <li class="mb-2 info-row">
                                <span class="info-label">
                                ...
                                <span
                                    ...
                                    class="float-end info-value"
                                >
                                    {{ optional($tagihanSiswa->first()->tagihan->kelas)->nama_kelas ?? "-" }}
                                </span>
                            </li>
                            <li class="mb-2 info-row">
                                <span class="info-label">
                                ...
                                <span
                                    ...
                                    class="float-end info-value"
                                >
                                    {{ ucfirst($tagihanSiswa->first()->tagihan->jenis_tagihan) ?? "-" }}
                                </span>
                            </li>
                            <li class="mb-2 info-row">
                                <span class="info-label">
                                ...
                                <span
                                    ...
                                    class="float-end info-value"
                                >
                                    {{ $tagihanSiswa->first()->tagihan->periode ?? 1 }}
                                    bulan
                                </span>
                            </li>
                            <li class="mb-2 info-row">
                                ...
                                <span
                                    ...
                                    class="float-end info-value"
                                >
                                    {{ $tagihanSiswa->first()->tagihan->bulan_mulai ?? "-" }}/{{ $tagihanSiswa->first()->tagihan->tahun_mulai ?? "-" }}
                                </span>
                            </li>
                            <li class="info-row">
                                <span class="info-label">
                            ...
                            <li class="info-row">
                                <span class="info-label">
                                    <i
                                        class="ri-wallet-line text-success me-2"
                                    ></i>
                                    <strong>No VA</strong>
                                </span>
                                <span class="info-label">
        ...
        <div class="card rounded-3 mb-4 border-0 shadow-sm">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table
                        class="table-bordered table-hover table overflow-hidden text-center align-middle"
                    >
                        <thead
                            ...
                            @forelse ($dataPerbulan as $index => $row)
                                <tr>
                                    ...
                                    <td>
                                        <strong>
                                            Rp
                                            {{ number_format($row["nominal_akhir"], 0, ",", ".") }}
                                        </strong>
                                    </td>
                                    <td>
                            ...
                            <tr class="table-warning">
                                ...
                                <th class="text-center">
                                    <strong class="text-danger">
                                        Rp
                                        {{ number_format($totalTagihan - $totalDibayar, 0, ",", ".") }}
                                    </strong>
                                </th>
                                <th colspan="4"></th>
                            </tr>
                        ...
                        <tbody>
                            @forelse ($pembayaranSiswa as $index => $pembayaran)
                                <tr>
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::parse($pembayaran["waktu_transaksi"])->format("d/m/Y H:i") }}
                                    </td>
                                    <td>
