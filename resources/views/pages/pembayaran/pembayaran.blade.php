                    ...
                    <div class="card-body position-relative">
                        ...
                        >
                            <div>
                                ...
                                <h3
                                    class="fw-bold text-danger mb-0 text-absolute"
                                >
                                    Rp
                                    {{ number_format($summary["total_tunggakan"], 0, ",", ".") }}
                                </h3>
                            </div>
                            <div
                    ...
                    <div class="card-body position-relative">
                        ...
                        >
                            <div>
                                ...
                                <h3
                                    class="fw-bold text-success mb-0 text-absolute"
                                >
                                    Rp
                        ...
                        <small class="text-muted d-block mt-2">
                            <i class="bx bx-wallet-alt text-success"></i>
                            Periode Bulan Ini
                        </small>
                        <small class="text-muted d-block mt-2">
                            <i class="bx bx-wallet-alt text-success"></i>
                    ...
                    <div class="card-body position-relative">
                        ...
                        >
                            <div>
                                ...
                                >
                                    Rp
                                    {{ number_format($summary["total_nontunai"], 0, ",", ".") }}
                                </h3>
                            </div>
                            <div
                            ...
                            >
                                <i
                                    class="bx bx-credit-card text-warning"
                                    style="font-size: 24px"
                                ></i>
                            </div>
                        </div>
                    ...
                    <div class="card-body position-relative">
                        ...
                        >
                            <div>
                                ...
                                <h3
                                    class="fw-bold text-info mb-0 text-absolute"
                                >
                                    Rp
                                    {{ number_format($summary["total_tunai"], 0, ",", ".") }}
                                </h3>
                            </div>
                            <div
        ...
        <div class="col-md-12 mt-4 p-3">
            <div class="card rounded-4 border-0 shadow-sm">
                ...
                <div class="row g-3 mb-4 px-3">
                    <div
                        class="col-md-12 px-4 mb-4"
                        id="nama_tagihan_wrapper"
                        style="display: none"
                    >
                        <label
                            for="nama_tagihan"
            ...
            <div class="card rounded-4 overflow-hidden border-0 pr-4 shadow-lg">
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-md-3 profile-card text-center">
                        ...
                        <h5
                            class="fw-bold mb-1 text-white fw-bold"
                        ...
                        <tbody id="list_tagihan">
                            <tr>
                                ...
                                >
                                    ...
                                    Silakan pilih siswa & nama tagihan
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
@push("scripts")
    <script>
        ...
        const listTagihanContainer = document.getElementById(
            'list_tagihan_container',
        );
        ...
        filterUnit.addEventListener('change', function () {
            ...
            siswaSelect.innerHTML =
                '<option value="">-- Pilih Siswa --</option>';
            document.getElementById('nama_tagihan_wrapper').style.display =
                'none';
        ...
        siswaSelect.addEventListener('change', function () {
            ...
            fetch(`/siswa/siswadetail/${siswaId}`)
                ...
                .then((data) => {
                    document.getElementById('detail_nama').innerText =
                        data.nama_lengkap;
                    document.getElementById('detail_nisn').innerText =
                        data.nisn;
                    document.getElementById('detail_unit').innerText =
                        data.unit;
                    document.getElementById('detail_kelas').innerText =
                        data.kelas;
                    document.getElementById('detail_va').innerText = data.va;
                    document.getElementById('detail_bank').innerText =
                        data.bank;
                    document.getElementById('detail_norek').innerText =
                        data.norek;
            ...
            fetch(`/tagihan/daftarTagihan/${siswaId}`)
                ...
                .then((data) => {
                    ...
                    const tagihanSelect =
                        document.getElementById('nama_tagihan');
        ...
        document
            ...
            .addEventListener('change', function () {
                ...
                fetch(endpoint)
                    ...
                    .then((data) => {
                        if (
                            !data.belum_lunas.length &&
                            !data.sudah_lunas.length
                        ) {
                ...
                <tr>
                    <td colspan="5" class="text-center text-muted py-4">
                        ...
                        // Render Belum Lunas
                        const tabelBelum = document.querySelector(
        ...
        `,
                        ...
                        // Render Sudah Lunas
                        const tabelLunas = document.querySelector(
                            '#tabelSudahLunas tbody',
                        );
                        tabelLunas.innerHTML = data.sudah_lunas
                            .map(
                                (tagihan) => `
            <tr>
                <td class="text-center">${tagihan.periode}</td>
                ...
                <td class="text-center"><span class="badge bg-success">LUNAS</span></td>
                                <td>
                                    ...
                                    <a href="{{ url("keuangan-transaksi/cetak-struk") }}/${tagihan.keuangan_transaksi_id}" class="btn btn-warning btn-sm rounded-pill" title="Cetak Struk" target="_blank">
                                     ...
                                     <a href="{{ url("tagihan/show") }}/${tagihan.tagihan_id}/${tagihan.siswa_id}" class="btn btn-primary btn-sm rounded-pill" title="Rekap" target="_blank">
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        didOpen: () => {
                            const input =
                                document.getElementById('swal-input-nominal');
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const btnProsesPembayaran = document.getElementById(
                'btnProsesPembayaran',
            );
        ...
        function simpanCatatan() {
            const tagihanId =
                document.getElementById('catatan_tagihan_id').value;
            const isiCatatan = document
                .getElementById('isiCatatan')
                .value.trim();
            ...
            fetch('/pembayaran/catatan', {
                ...
                .then((data) => {
                    if (data.status === 1) {
                        ...
                        Swal.fire(
                            'Gagal!',
                            data.message || 'Tidak dapat menyimpan catatan.',
                            'error',
                        );
                    }
                })
        ...
        function prosesMultiplePembayaran(selectedTagihan) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const tagihanIds = selectedTagihan.map((t) =>
                        parseInt(t.id),
                    );
                    ...
                    fetch('/pembayaran/proses-multiple-with-detail', {
                        ...
                        .then((data) => {
                            if (data.status) {
                                ...
                                Swal.fire(
                                    'Gagal!',
                                    data.message || 'Pembayaran gagal diproses',
                                    'error',
                                );
                            }
                        })
