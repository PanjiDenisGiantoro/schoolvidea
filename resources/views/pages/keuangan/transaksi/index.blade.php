                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        @if ($transaksi->status_verifikasi == 'pending')
                                            <button type="button"
                                                class="btn btn-sm btn-success rounded-pill btn-approve-trx"
                                                data-id="{{ $transaksi->id }}" title="Approve">
                                                <i class="bx bx-check"></i>
                                            </button>
                                            <button type="button"
                                                class="btn btn-sm btn-danger rounded-pill btn-reject-trx"
                                                data-id="{{ $transaksi->id }}" title="Reject">
                                                <i class="bx bx-x"></i>
                                            </button>
                                        @endif
                                    </div>
