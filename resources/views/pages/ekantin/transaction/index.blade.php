@extends("layouts.app")
@section("title", "Data Transaksi Merchant")
@push("styles")
...
@section("content")
    @include(
        "partials.page-title",
        [
            "title" => "Data Transaksi Merchant",
            "subTitle" => "Kelola Data Transaksi Merchant",
        ]
    )
            ...
            >
                <div class="card-body position-relative">
                    ...
                    >
                        ...
                        >
                            <i
                                class="ri-timer-flash-line text-danger"
                                style="font-size: 24px"
                            ></i>
                        </div>
                    </div>
        ...
        @if ((auth()->user()->yayasan_id && ! auth()->user()->unit_id) || (! auth()->user()->yayasan_id && ! auth()->user()->unit_id))
            <div class="card rounded-3 border-0 shadow-sm mb-2">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route("merchant_transaction.index") }}"
                        method="GET"
                    >
                        <div class="row g-3 collapse" id="filterCollapse">
                            ...
                            <div class="col-md-2 d-flex align-items-end gap-2">
                                ...
                                <a
                                    href="{{ route("merchant_transaction.index") }}"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            merchantTable = $('#merchantTable').DataTable({
                ...
                ajax: {
                    url: '{{ route("merchant_transaction.datatable") }}',
                    type: 'GET',
                    data: function (d) {
