        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="menu-item">
                ...
                <div class="collapse" id="sidebarPenggajian">
                    <ul class="sub-menu-nav">
                        <li class="sub-menu-item"><a class="sub-menu-link"
                                href="{{ url('payroll-components') }}">Komponen Gaji</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link"
                                href="{{ url('payroll-deductions') }}">Potongan</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link"
                                href="{{ url('payroll-setting') }}">Setting Gaji</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link"
                                href="{{ url('payroll-payment') }}">Pembayaran Gaji</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="menu-item">
                ...
                <div class="collapse" id="sidebarEkantin">
                    <ul class="sub-menu-nav">
                        <li class="sub-menu-item"><a class="sub-menu-link" href="{{ url('#') }}">Data
                                Merchant</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link" href="{{ url('#') }}">Data
                                Transaksi</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link" href="{{ url('#') }}">Penarikan
                                Dana</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link" href="{{ url('#') }}">Akses
                                Halaman</a></li>
                        <li class="sub-menu-item">
                            <a class="sub-menu-item menu-link menu-arrow" href="#sidebarSetEkantin"
                                data-bs-toggle="collapse" role="button" aria-expanded="false"
                            ...
                            <div class="collapse" id="sidebarSetEkantin">
                                <ul class="sub-menu-nav">
                                    <li class="sub-menu-item"><a class="sub-menu-link"
                                            href="{{ url('#') }}">Set. Umum</a></li>
                                    <li class="sub-menu-item"><a class="sub-menu-link"
                                            href="{{ url('#') }}">Set. Transaksi</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <li class="menu-item">
                ...
                <div class="collapse" id="sidebarDonasi">
                    <ul class="sub-menu-nav">
                        <li class="sub-menu-item"><a class="sub-menu-link" href="{{ url('#') }}">Data
                                Lembaga</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link" href="{{ url('#') }}">Riwayat
                                Donasi</a></li>
                        <li class="sub-menu-item"><a class="sub-menu-link" href="{{ url('#') }}">Setting
                                Donasi</a></li>
                    </ul>
                </div>
            </li>
