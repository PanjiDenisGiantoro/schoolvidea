...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:api')->group(function () {
        ...
        Route::get('tagihan-siswa/siswa/{siswaId}', [\App\Http\Controllers\Api\V1\TagihanSiswaController::class, 'getBySiswa']);
        Route::get('tagihan-siswa/kelas/{kelasId}', [\App\Http\Controllers\Api\V1\TagihanSiswaController::class, 'getByKelas']);
        Route::get('tagihan-siswa/unpaid/{siswaId}', [\App\Http\Controllers\Api\V1\TagihanSiswaController::class, 'getUnpaid']);
        Route::apiResource('tagihan-siswa', \App\Http\Controllers\Api\V1\TagihanSiswaController::class)->only(['index', 'show']);

        // Unit routes
        Route::apiResource('unit', \App\Http\Controllers\Api\V1\UnitController::class);
